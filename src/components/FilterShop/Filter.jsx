...
const Filter = () => {
  return (
    <nav className='mt-3 text-sm flex flex-col gap-1'>
      ...
      <NavLink to='/shop/headphones' className='text-slate-800 hover:text-slate-500'>Headphones</NavLink>
      <NavLink to='/shop/speakers' className='text-slate-800 hover:text-slate-500'>Speakers</NavLink>
