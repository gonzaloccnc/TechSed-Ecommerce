...
import { selectProduct } from '../../store/selectStatus'
...
const Products = () => {
  ...
  } = useSelector(selectProduct).find(p => p.id === id)
    ...
    <main className='w-full h-auto bg-white py-10 mt-[164.5px]'>
      <section className='w-[890px] mx-auto'>
        ...
        <section className='w-full flex justify-between'>
          <div className='w-1/2'>
            <img src={imgURL} className='w-full h-auto border border-solid border-input mb-10' />
