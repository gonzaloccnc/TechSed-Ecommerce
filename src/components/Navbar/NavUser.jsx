...
const NavUser = () => {
  return (
    <nav id='navbar-user' className='py-2 px-6 flex items-center justify-between'>
      ...
      <div className='flex gap-8'>
        ...
        <Link to='/favorites' className='underline inline-flex items-center gap-2 text-sm'>
        ...
        <Link to='/mycart' className='inline-flex items-center gap-2'>
          <BsCart2 fontSize='25' />
          <span
            className='text-white grid place-content-center text-xs w-4 h-4 rounded-full bg-black'
          >
            0
          </span>
        </Link>
