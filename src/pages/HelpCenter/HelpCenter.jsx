...
const HelpCenter = () => {
  ...
  return (
    <motion.main
      ...
      exit={{ opacity: 0 }}
    >
      <h1 className='text-center text-5xl font-semibold pb-28'>
        TechSed Support
      </h1>
      <div className='w-4/5 mx-auto'>
        <div className='w-full flex justify-around items-center mb-4'>
          <h2 className='w-1/2 text-right font-semibold text-3xl'>
                ...
                <div className='w-full'>
                  <Accordion title='How do I add a new question and answer?'>
                    ...
                    <ol className='list-decimal pl-8 py-4 font-light text-sm'>
                      ...
                      <li>
                        From your site's dashboard click 'Add' and then choose the
                    ...
                    <p className='font-light text-sm'>
                      You can always edit your FAQs, reorder them and select other
                      categories.
                    </p>
                  </Accordion>
                  <Accordion title='Can you insert an image, video or gif to my FAQ?'>
                    <p className='font-light text-sm'>
                      Yes. To add media content, follow these steps:
                    </p>
                    <ol className='list-decimal pl-8 py-4 font-light text-sm'>
                      <li>Go to the app options</li>
                      <li>Click on Manage FAQ</li>
                      <li>
                        Create or choose the question you want to add media to
                      </li>
                      <li>
                        When editing your answer, click the image, video, or gif
                        icon
                      </li>
                      <li>
                        Add the content from your library and save the changes.
                      </li>
                    </ol>
                  </Accordion>
                  <Accordion title='How can you edit or remove the FAQ title?'>
                    <p className='font-light text-sm'>
                      You can edit the title from the options tab in the app. If
                      you don't want to display the title, disable the option from
                ...
                <div className='w-full'>
                  <Accordion title='What is a FAQ section?'>
                    <p className='font-light text-sm pb-4'>
                      A FAQ (Frequently Asked Questions) section serves to quickly
                      answer common questions about your business such as 'What
                      are your hours?', 'Where do you ship to?' or 'How can I make
                      a reservation?' FAQs are a great way to help people navigate
